/**
  ...
  * @brief   This file provides the VL53L7CX ranging sensor component driver
  ******************************************************************************
  * @attention
  *
...
/** @addtogroup VL53L7CX
  ...
  *            VL53L7CX ranging sensor.
  * @{
  */

/** @defgroup VL53L7CX_Private_TypesDefinitions Private Types Definitions
  * @{
  */

/* 0x1388 corresponds to 5000 decimal. This will do a timeout of 5 seconds */
#define V53L7CX_POLL_TIMEOUT  (0x1388U)
...
/** @defgroup VL53L7CX_Private_Variables Private Variables
  * @{
  */

VL53L7CX_RANGING_SENSOR_Drv_t VL53L7CX_RANGING_SENSOR_Driver =
{
  VL53L7CX_Init,
  VL53L7CX_DeInit,
  VL53L7CX_ReadID,
  VL53L7CX_GetCapabilities,
  VL53L7CX_ConfigProfile,
  VL53L7CX_ConfigROI,
  VL53L7CX_ConfigIT,
  VL53L7CX_GetDistance,
  VL53L7CX_Start,
  VL53L7CX_Stop,
  VL53L7CX_SetAddress,
  VL53L7CX_GetAddress,
  VL53L7CX_SetPowerMode,
  VL53L7CX_GetPowerMode
};
...
/** @defgroup VL53L7CX_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
/**
  * @brief Initializes the vl53l7cx context object.
...
/**
  * @brief Read the vl53l7cx device ID.
  * @param pObj    vl53l7cx context object.
...
/**
  * @brief Get the vl53l7cx capabilities.
  * @param pObj    vl53l7cx context object.
...
/**
  * @brief Configure the Region of Interest of the vl53l7cx.
  * @param pObj    vl53l7cx context object.
...
int32_t VL53L7CX_XTalkCalibration(VL53L7CX_Object_t *pObj, uint16_t Reflectance, uint16_t Distance)
{
  ...
  status = vl53l7cx_calibrate_xtalk(
      &pObj->Dev,
      Reflectance,
      nb_samples,
      Distance);

  ret = (status == VL53L7CX_STATUS_OK) ? VL53L7CX_OK : VL53L7CX_ERROR;
