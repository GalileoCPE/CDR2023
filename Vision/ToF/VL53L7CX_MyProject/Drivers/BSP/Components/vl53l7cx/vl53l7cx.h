...
/* vl53l7cx threshold/interrupt criterias */
...
typedef int32_t (*VL53L7CX_Delay_Func)(uint32_t);
...
typedef struct
{
  ...
  uint16_t Address;
  VL53L7CX_WriteReg_Func WriteReg;
  VL53L7CX_ReadReg_Func ReadReg;
...
typedef struct
{
  ...
  int32_t (*GetCapabilities)(VL53L7CX_Object_t *, VL53L7CX_Capabilities_t *);
  int32_t (*ConfigProfile)(VL53L7CX_Object_t *, VL53L7CX_ProfileConfig_t *);
  int32_t (*ConfigROI)(VL53L7CX_Object_t *, VL53L7CX_ROIConfig_t *);
  int32_t (*ConfigIT)(VL53L7CX_Object_t *, VL53L7CX_ITConfig_t *);
  int32_t (*GetDistance)(VL53L7CX_Object_t *, VL53L7CX_Result_t *);
  int32_t (*Start)(VL53L7CX_Object_t *, uint32_t);
  int32_t (*Stop)(VL53L7CX_Object_t *);
  int32_t (*SetAddress)(VL53L7CX_Object_t *, uint32_t);
  int32_t (*GetAddress)(VL53L7CX_Object_t *, uint32_t *);
  int32_t (*SetPowerMode)(VL53L7CX_Object_t *, uint32_t);
